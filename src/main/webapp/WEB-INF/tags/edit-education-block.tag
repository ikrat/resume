	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div class="col-xs-4 col-sm-8 col-md-12">
				...
				<textarea name="items[${index }].summary" class="form-control-skills" style="resize: none;" required="required">${education.summary }</textarea>
			</div>
			<div class="row">
				<div class="col-lg-6 col-sm-6 ">
					<div class="input-practic">
						<label>*Begin date:</label> 
						<select class="form-control" name="items[${index }].beginYear" required="required">
							...
							<option ${education.beginYear == 1990 ? ' selected="selected"' : ''}>1990</option>
				...
				<div class="col-lg-6 col-sm-6">
					...
					<label>*Finish date:</label> 
						<select class="form-control" name="items[${index }].finishYear" required="required">
			...
			<div class="col-xs-4 col-sm-4 col-md-6">
				<br>
				<p><b>*University:</b></p>
				<textarea name="items[${index }].university" class="form-control" style="resize: none;" required="required">${education.university }</textarea>
			</div>
			<div class="col-xs-4 col-sm-4 col-md-6">
				<br>
				<p><b>*Faculty:</b></p>
				<textarea name="items[${index }].faculty" class="form-control" style="resize: none;" required="required">${education.faculty }</textarea>
			</div>
		</div>
	</div>
</div>